  ...
  <div class="header" v-bind:class="isGrew?'t-999999':'t-ffffff'">
      <nav class="clearfix" style="background-color:rgba(255,255,255,0)" ref="nav">
        ...
        <div class="relogin clearfix" id="s">
          <p><span v-if="username==' '"><router-link :to="{ name: 'Login'}"  v-bind:class="isGrew?'t-999999':'t-ffffff'">登陆/注册</router-link></span><router-link :to="{ path: '/userCenter/welcomeUser'}" v-bind:class="isGrew?'t-999999':'t-ffffff'" v-else><span  v-html="username"></span></router-link></p>
